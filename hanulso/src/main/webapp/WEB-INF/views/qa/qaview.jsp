			...
			<c:if test="${view.state eq '2' }">
				...
				<div style="padding:20px 0;">
					...
					<input type="hidden" name="awriter" value="${user.id}">
						...
						<button type = "submit" style="width:10%;height:100px;" id="useronly">답변저장</button>	
					</form>
				</div>
			<div class="prev_next">
			<c:choose>
				...
				<div class="btn_3wrap">
					...
					<a href="/qa/modify?qbno=${view.qbno}&pageNum=${cri.pageNum }&amount=${cri.amount }" id="useronly">수정</a> 
